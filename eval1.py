...
if __name__ == "__main__":
    ...
    add_book("9", "Lion king", "F. Scott Fitzgerald", "Fiction", True)
    add_book("1", "1984", "George Orwell", "HORROR", True)
    add_book("3", "To Kill a Mockingbird", "Harper Lee", "Fiction", False)
    
    
    update_book_details("9", availability=False)
    
    
    book = search_by_isbn("9")
    if book:
